const About = () => {
  return (
    <div
      id="about"
      className="flex flex-col lg:flex-row stretch-to-screen bg-[#1A1330] text-white items-center px-10"
    >
      <div id="left" className="basis-1/2 mx-4 ">
        <p className="text-7xl mt-16  font-extrabold shadow-inner ">About Recharge</p>
