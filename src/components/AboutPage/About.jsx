    ...
    return (
            <div id="about" className="flex flex-col lg:flex-row stretch-to-screen bg-[#06111f] text-white items-center">
                <div id="left" className="basis-1/2">
                    ...
                    <button className="border border-[#b718f1] drop-shadow-lg ml-10 lg:ml-24 text-white px-4 py-2 rounded-md font-medium my-4 hover:bg-[#b718f1] hover:text-black hover:duration-1000">
                        Show More
                    </button>
