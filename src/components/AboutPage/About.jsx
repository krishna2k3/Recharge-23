...
const About = () => {
  ...
  return (
    ...
    >
      ...
      Established in 1997, Rajalakshmi Engineering College (REC) is an autonomous institution affiliated with Anna University, Chennai, that produces top-notch professionals. REC has a student-centric approach, offering various student-run societies and clubs that organize hackathons,symposiums, seminars, workshops and provide a diverse range of programs to its 8000 students. REC's students are true champions, earning accolades in a myriad of fields. Our intra-college events offer students a break from engineering, creating unforgettable experiences. Mark your calendars for Recharge 2023, our electrifying national cultural fest. It showcases the incredible talents of students from all over the country, with jaw-dropping performances and show-stopping appearances that will leave you wanting more! These events do not only provide students with a refreshing break from their academic routines, but also offer them opportunities to interact with professionals from various fields, inspiring and motivating them to pursue their passions.
      </p>
    </div>
  );
};
