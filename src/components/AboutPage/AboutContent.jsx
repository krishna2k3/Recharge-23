const AboutContent = ()=>{
    return (
        <div className="stretch-to-screen items-center">
            ...
            <p className="mx-10 my-10 lg:my-16 lg:mx-52 text-lg justify-between">
                ...
                <br></br><br></br>Recharge 2023 has been conceptualised to be the flagship Cultural Event of Rajalakshmi institutions. The team at Recharge 2023 have been working tirelessly to bring about a truly memorable Intercollegiate cultural fest to all participants. The festival will serve as a platform for budding young artists to showcase their talent to the best of the judges from their respective fields. It's said that food and fun are synonymous, well at Recharge we promise you both. Our amazing lineup of food stalls and events stand testimony to that. At the end of the day any intercollegiate event happens to be the best place to meet new people and make new memories. The Recharge team is fully committed to delivering a truly best in class cultural fest.
                <br></br><br></br>We hope you come and enjoy our fest that's filled with food, fun and frolic and make memories that you will carry a lifetime ahead.
            </p>
