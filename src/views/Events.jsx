...
const Events = () => {
    const events = [{title: "Dance 1", category: "dance"}, {title: "Game 1", category: "game"}, 
                    {title: "Sing 1", category: "sing"}, {title: "Dance 2", category: "dance"},
                     {title: "Sing 2", category: "sing"}, {title: "Game 2", category: "game"}, 
                     {title: "Sing 3", category: "sing"}, {title: "Game 4", category: "game"}, 
                     {title: "Game 3", category: "game"}, {title: "Dance 3", category: "dance"}, 
    ...
    return <div id="events">
        ...
        <div id="content" className="flex flex-col m-20">
            ...
            <button onClick={() => filterEvents("all")} className="bg-teal-600 text-white rounded-2xl p-3 text-lg mr-5">All</button>
                ...
                <button onClick={() => filterEvents("sing")} className="bg-teal-600 text-white rounded-2xl p-3 text-lg mr-5">Singing</button>
                <button onClick={() => filterEvents("game")} className="bg-teal-600 text-white rounded-2xl p-3 text-lg">Gaming</button>
            </div>
